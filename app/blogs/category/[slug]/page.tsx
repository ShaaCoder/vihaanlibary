...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!category) {
    return { title: 'Category Not Found - Vihaan Education Academy' };
  }

  return {
    title: `${category.name} Articles - Vihaan Education Academy Blog`,
    description: category.description || `Browse ${category.name} articles, tips, and insights from Vihaan Education Academy.`,
    openGraph: {
      title: `${category.name} - Vihaan Education Academy Blog`,
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            isPartOf: {
              '@type': 'Blog',
              name: 'Vihaan Education Academy Blog',
