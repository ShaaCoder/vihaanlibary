...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!tag) {
    return { title: 'Tag Not Found - Vihaan Education Academy' };
  }

  return {
    title: `${tag.name} Articles - Vihaan Education Academy Blog`,
    description: `Browse articles tagged with "${tag.name}" from Vihaan Education Academy.`,
    openGraph: {
      title: `${tag.name} - Vihaan Education Academy Blog`,
      description: `Browse articles tagged with "${tag.name}" from Vihaan Education Academy.`,
